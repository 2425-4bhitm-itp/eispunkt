<script lang="ts">
	...
	async function getAllTeams() {
		const res = await fetch('https://it200230.cloud.htl-leonding.ac.at/api/teams/0', {
			method: 'GET'
		});
...
<div id="body-div">
	...
	<div id="team-details-outer-box">
		<div id="search-add-box">
			<input id="search-input" type="text" placeholder="Suchen" bind:value={searchTerm} />
			<div
				id="addButton"
				onclick={() => {
					showModal = true;
				...
				<div class="svg-box">
					...
					>
						<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 20 20">
							<path
								fill="#7FC8EE"
								d="m12.3 3.7l4 4L4 20H0v-4L12.3 3.7zm1.4-1.4L16 0l4 4l-2.3 2.3l-4-4z"
							/>
						</svg>
					</a>
                    ...
                    6H18C18.55 6 19 5.55 19 5C19 4.45 18.55 4 18 4Z"
							fill="#7FC8EE"
						/>
					</svg>
				</div>
