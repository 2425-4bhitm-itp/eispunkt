...
<div id="outer_form_box">
	...
	<div class="form">
		<div class="input-container ic1">
			<input id="teamname" class="input" type="text" placeholder=" " bind:value={teamName} />
			<div class="cut cut-long"></div>
			<label for="teamname" class="placeholder">Team name</label>
		</div>
		<div class="input-container ic2">
			<input id="player1" class="input" type="text" placeholder=" " bind:value={players[0]} />
			<div class="cut"></div>
			<label for="player1" class="placeholder">Player 1</label>
		</div>
		<div class="input-container ic2">
			<input id="player2" class="input" type="text" placeholder=" " bind:value={players[1]} />
			<div class="cut"></div>
			<label for="player2" class="placeholder">Player 2</label>
		</div>
		<div class="input-container ic2">
			<input id="player3" class="input" type="text" placeholder=" " bind:value={players[2]} />
			<div class="cut"></div>
			<label for="player3" class="placeholder">Player 3</label>
		</div>
		<div class="input-container ic2">
			<input id="player4" class="input" type="text" placeholder=" " bind:value={players[3]} />
			<div class="cut"></div>
