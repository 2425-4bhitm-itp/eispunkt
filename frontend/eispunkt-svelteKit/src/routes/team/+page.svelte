...
<div id="body-div">
    ...
    <div id="team-details-outer-box">
        <div class="team-details">
            <h1>Eispunkt</h1>
            <div class="svg-box">
                <svg on:click={teamDetails} xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 20 20">
                    <path fill="#7FC8EE" d="m12.3 3.7l4 4L4 20H0v-4L12.3 3.7zm1.4-1.4L16 0l4 4l-2.3 2.3l-4-4z"/>
                </svg>

                <svg on:click={deleteTeam} width="50" height="50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {#if showModal}
        <div class="overlay active">
            <div class="modal">
                ...
                <input id="name" type="text" bind:value={teamName} placeholder="Teamname eingeben" />
