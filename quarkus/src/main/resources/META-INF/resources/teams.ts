function nextTeam(){
    ...
    document.getElementById("buttonBox").innerHTML = '<button id="playButton"><a onclick="savePlayers()" href="game.html">Play</a></button>'

}

function savePlayers(){
    let t2player1 = document.getElementById("player1").innerText.valueOf()
    let t2player2 = document.getElementById("player2").innerText.valueOf()
    let t2player3 = document.getElementById("player3").innerText.valueOf()
    let t2player4 = document.getElementById("player4").innerText.valueOf()
}